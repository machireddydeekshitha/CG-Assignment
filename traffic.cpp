...
glColor3f(1,0,0);
drawstring(450.0,700.0,0.0,"BMS INSTITUTE OF TECHNOLOGY & MANAGEMENT");
glColor3f(0.7,0,1);
...
glColor3f(1,1,1);
drawstring(100,300,0.0,"M.DEEKSHITHA");
glColor3f(1,1,1);
drawstring(100,240,0.0,"PRATHEEKSHA P.A");
glColor3f(1,0.5,0);
drawstring(980,400,0.0,"GUIDES:");
glColor3f(1,1,1);
drawstring(930,300,0.0,"MR SHANKAR.R");
glColor3f(1,1,1);
